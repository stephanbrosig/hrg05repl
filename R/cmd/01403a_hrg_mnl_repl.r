...
#asm <- as.tibble(readRDS(file = "dat/01401_hensher_imp.Rds"))  
asm <- as_tibble(readRDS(file = "dat/01401a_hensher_imp_repl.Rds"))  
...
### Set core controls
apollo_control = list(
  modelName       = "01403a_hensher_mnl_repl",
  modelDescr      = "01403a_hensher_mnl_repl: Replication of Hensher Ch 10.3(p. 316f) MNL result",
  indivID         = "id", 
  outputDirectory = "01403a_hensher_mnl_repl", 
  panelData = TRUE
#  workInLogs=TRUE
)
