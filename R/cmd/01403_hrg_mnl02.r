...
### Set core controls
apollo_control = list(
  modelName       = "01403_hrg_mnl02",
  modelDescr      = "01403a_hrg_mnl02: Replication of hrg p. 329f ASC only model",
  indivID         = "id", 
...
LL1 <- readRDS(file = "01403_hrg_mnl/01403_hrg_mnl01_model.rds")$finalLL
